...
//extern tcb_queue_t ntfn_ptr_get_queue(notification_t *ntfnPtr);
...
//extern void ntfn_ptr_set_queue(notification_t *ntfnPtr, tcb_queue_t ntfn_queue);
...
//extern void doUnbindNotification(notification_t *ntfnPtr, tcb_t *tcbptr);
...
//extern void unbindMaybeNotification(notification_t *ntfnPtr);
...
//extern void unbindNotification(tcb_t *tcb);
...
//extern void bindNotification(tcb_t *tcb, notification_t *ntfnPtr);
